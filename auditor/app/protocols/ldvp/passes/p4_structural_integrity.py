...
from auditor.app.protocols.ldvp.schemas.p4_output import P4Output  
  
from auditor.app.schemas.findings import FindingSource  
  
  
class LDVPPass4StructuralIntegrity(  
    LDVPPassMixin,  
    SemanticAuditPass,  
):  
    """  
    LDVP Pass 4: Structural Integrity.  
    """  
    ...
    async def run(self, context: SemanticAuditContext) -> SemanticAuditPassResult:  
        ...
        for chunk in chunks:  
            ...
            # Semantic findings  
            # ----------------------------------------------------------  
            output: P4Output = execution.output  # type: ignore[assignment]  

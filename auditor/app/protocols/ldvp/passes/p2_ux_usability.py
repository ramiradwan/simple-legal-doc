...
from auditor.app.protocols.ldvp.schemas.p2_output import P2Output  
  
from auditor.app.schemas.findings import FindingSource  
  
  
class LDVPPass2UXUsability(  
    LDVPPassMixin,  
    SemanticAuditPass,  
):  
    """  
    LDVP Pass 2: UX & Usability.  
    """  
    ...
    async def run(self, context: SemanticAuditContext) -> SemanticAuditPassResult:  
        ...
        for chunk in chunks:  
            ...
            # Semantic findings  
            # ----------------------------------------------------------  
            output: P2Output = execution.output  # type: ignore[assignment]  

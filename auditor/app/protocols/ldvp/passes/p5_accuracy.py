...
from auditor.app.protocols.ldvp.schemas.p5_output import P5Output  
  
from auditor.app.schemas.findings import FindingSource  
  
  
class LDVPPass5Accuracy(  
    LDVPPassMixin,  
    SemanticAuditPass,  
):  
    """  
    LDVP Pass 5: Accuracy.  
    """  
    ...
    async def run(self, context: SemanticAuditContext) -> SemanticAuditPassResult:  
        ...
        for chunk in chunks:  
            ...
            # Semantic findings  
            # ----------------------------------------------------------  
            output: P5Output = execution.output  # type: ignore[assignment]  
